      ...
      <nav className="relative max-w-9xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-12 h-20" aria-label="Global">
        ...
        <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
          <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
            ...
            <a className="font-medium text-black hover:text-blue-600 sm:py-6 dark:text-white dark:hover:text-blue-600" href="#">EVENTS</a>
            <a className="font-medium text-black hover:text-blue-600 sm:py-6 dark:text-white dark:hover:text-blue-600" href="#">MEMBERS</a>
            <a className="font-medium text-black hover:text-blue-600 sm:py-6 dark:text-white dark:hover:text-blue-600" href="#">CONTACT</a>
          </div>
        </div>
      </nav>
    </header>
